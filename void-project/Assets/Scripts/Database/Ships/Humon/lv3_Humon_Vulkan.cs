...
public static partial class ShipID {
    ...
    public const int Humon_Vulkan = 13;
}

public class Humon_Vulkan : ShipData {

//INFO
    public override string shipName => "Vulkan";
    public override int shipId => ShipID.Humon_Vulkan;
    public override int parentId => ShipID.Humon_Jet;
    public override int setId => 12;
...
public class Humon_Vulkan_Collider : ColliderData {

    public override int id => ShipID.Humon_Vulkan;
