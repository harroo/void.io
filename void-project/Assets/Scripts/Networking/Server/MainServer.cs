    ...
    private static SendNode Process (TcpClient client, byte[] packet) {
        ...
        switch (packet[0]) {
            ...
            case 0: { //create object
                ...
                Buffer.BlockCopy(BitConverter.GetBytes(9), 0, rbuf, 0, 4);
                rbuf[4] = 0;
                Buffer.BlockCopy(BitConverter.GetBytes(objectID), 0, rbuf, 5, 4);
                Buffer.BlockCopy(BitConverter.GetBytes(type), 0, rbuf, 9, 4);

                ServerSave.CreateNewObject(objectID, type);

                ObjectManager.instance.CreateObject(objectID, type);
            ...
            case 1: { //delete object
                ...
                ObjectManager.instance.DeleteObject(objectID);
            ...
            case 2: { //update object
                ...
                ObjectManager.instance.UpdateObject(objectID, objectBuf);
            ...
            case 5: { //create object with data
                ...
                //asign the values
                ServerSave.CreateNewObject(objectID, type, meta);
                ObjectManager.instance.CreateObject(objectID, type, meta);

                //make buffer create res packet
                packet[0] = 4;

                //return it
                return new SendNode(packet);
            }
        }
